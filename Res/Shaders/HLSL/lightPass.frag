...
PixelOutputType main(PixelInputType input) : SV_TARGET
{
	...
	if (GPassRT0.a)
	{
		...
		float4 GPassRT3 = in_opaquePassRT3.Sample(SamplerTypePoint, input.texcoord);
	...
	{
		output.lightPassRT0 = float4(0.0, 0.0, 0.0, 0.0);
		output.lightPassRT1 = float4(0.0, 0.0, 0.0, 0.0);
	}
