...
Start-Process Debug/InnoBaker.exe -ArgumentList "-renderer 1 -mode 0 -loglevel 1 -bakestage brick ..//Res//Intermediate//$sceneName.InnoBrickCacheSummary" -Wait

Write-Output "Generate brick factor and probe for $sceneName scene..."
Start-Process Debug/InnoBaker.exe -ArgumentList "-renderer 1 -mode 0 -loglevel 1 -bakestage brickfactor ..//Res//Scenes//$sceneName.InnoBrick" -Wait
pause