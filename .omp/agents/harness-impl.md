...
name: harness-impl
description: |
  AI-harness implementation — `.omp/extensions/` (TS gates/extensions), `.omp/skills/`, `.omp/agents/`, `.omp/state/`, `AGENTS.md`. TypeScript + Markdown.
model: inherit
spawns: ""
---
...
Outputs: commit-guard gate/extension changes, agent manifest changes, skill edits under `.omp/skills/`, `.omp/state/*.md` updates.
