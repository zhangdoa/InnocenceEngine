...
// Core serializer round-trip fixtures (enum strings, BRDFLUT compute graph,
// buffer + imported resource, DrawModelGroups culling). The driver in
// RenderGraphSerializerTests.cpp calls these via extern; per-feature fixtures
// (SSAO, ping-pong, raster, raytracing, bypass, tiled, LightPass) live in their
// own _<feature>.cpp siblings.
...
void TestComputeCullingRoundTrip()
{
