...
bool TiledFrustumGenerationPass::Setup(ISystemConfig* systemConfig)
{
	...
	m_DispatchParamsGPUBufferComp = l_renderingServer->AddGPUBufferComponent("TiledFrustumDispatchParams/");
	...
	m_CommandListComp_Compute = l_renderingServer->AddCommandListComponent("TiledFrustumGenerationPass/Compute/");
...
bool TiledFrustumGenerationPass::Update()
{
	...
	l_renderingServer->Upload(m_DispatchParamsGPUBufferComp, &l_tiledFrustumWorkload, 0, 1);
...
bool TiledFrustumGenerationPass::PrepareCommandList(IRenderingContext* renderingContext)
{
	...
	l_renderingServer->BindGPUResource(m_RenderPassComp, m_CommandListComp_Compute, ShaderStage::Compute, m_DispatchParamsGPUBufferComp, 1);
	l_renderingServer->BindGPUResource(m_RenderPassComp, m_CommandListComp_Compute, ShaderStage::Compute, m_TiledFrustum, 2);
