...
bool SSAOPass::Setup()
{
	...
	m_SSAONoiseTDC->m_textureDataDesc.UsageType = TextureUsageType::ColorAttachment;
...
bool SSAOPass::PrepareCommandList()
{
	...
	g_pModuleManager->getRenderingServer()->ActivateResourceBinder(m_RPDC, ShaderStage::Pixel, l_CameraGBDC->m_ResourceBinder, 0, 0);
	g_pModuleManager->getRenderingServer()->ActivateResourceBinder(m_RPDC, ShaderStage::Pixel, m_SSAOKernelGPUBuffer->m_ResourceBinder, 1, 0);
