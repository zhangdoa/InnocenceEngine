...
// opaque-pass / GPU-PT exclusive — see SSRCRaytracingPass.cpp slot
...
// PT's PTClosestHit follows. The conservative 0.5 keeps the
...
//
// Convention vs GPU PT (PTRayGen.hlsl sky-NEE block):
...
float3 SampleSkyNEE(float3 hitPositionWS, uint frameIndex)
{
    ...
    // payload stays at its sentinel. A miss runs the existing SSRCMiss
