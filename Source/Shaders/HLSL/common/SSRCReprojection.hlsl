...
// Included by SSRCReprojection.comp; not standalone-compileable.
// The orchestrating kernel must:
//   1. Bind `in_SSRCResults_Prev`, `in_ProbePosition`, `in_ProbeNormal`
...
//   hitDist: ray.TMax = 1000.0 (SSRCRayGen); QUANT_DIST=65536 →
