...
MeshDataComponent * DX12RenderingServer::GetMeshDataComponent(MeshShapeType meshShapeType)
{
	return nullptr;
}

TextureDataComponent * DX12RenderingServer::GetTextureDataComponent(TextureUsageType textureUsageType)
{
	return nullptr;
}

TextureDataComponent * DX12RenderingServer::GetTextureDataComponent(WorldEditorIconType iconType)
{
	return nullptr;
}
...
bool DX12RenderingServer::BindGPUBuffer(ShaderType shaderType, GPUBufferAccessibility accessibility, GPUBufferDataComponent * GPUBufferDataComponent, size_t startOffset, size_t range)
{
	return true;
}
...
bool DX12RenderingServer::BindMaterialDataComponent(MaterialDataComponent * rhs)
{
	return true;
}

bool DX12RenderingServer::DispatchDrawCall(MeshDataComponent * rhs)
{
	return true;
}

bool DX12RenderingServer::UnbindMaterialDataComponent(RenderPassDataComponent * rhs)
{
	return true;
}
