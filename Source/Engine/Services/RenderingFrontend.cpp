...
bool RenderingFrontendNS::Setup(ISystemConfig* systemConfig)
{
	...
	f_sceneLoadingFinishCallback = [&]()
	{
		...
		l_billboardPassDrawCallInfoVectorA[0].iconTexture = g_Engine->Get<RenderingFrontend>()->GetTextureComponent(WorldEditorIconType::DIRECTIONAL_LIGHT);
		l_billboardPassDrawCallInfoVectorA[1].iconTexture = g_Engine->Get<RenderingFrontend>()->GetTextureComponent(WorldEditorIconType::POINT_LIGHT);
		l_billboardPassDrawCallInfoVectorA[2].iconTexture = g_Engine->Get<RenderingFrontend>()->GetTextureComponent(WorldEditorIconType::SPHERE_LIGHT);
