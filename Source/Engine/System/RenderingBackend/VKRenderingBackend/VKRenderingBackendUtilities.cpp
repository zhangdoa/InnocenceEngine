...
bool VKRenderingBackendNS::createRenderTargets(VKRenderPassComponent* VKRPC)
{
	...
	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_DEV_SUCCESS, "VKRenderingBackend: Render targets have been created.");
...
bool VKRenderingBackendNS::createRenderPass(VKRenderPassComponent* VKRPC)
{
	...
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to create VkRenderPass!");
		return false;
	}

	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_DEV_SUCCESS, "VKRenderingBackend: VkRenderPass has been created.");
	return true;
}
...
bool VKRenderingBackendNS::createSingleFramebuffer(VKRenderPassComponent* VKRPC)
{
	...
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to create VkFramebuffer!");
	}

	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_DEV_SUCCESS, "VKRenderingBackend: Single VkFramebuffer has been created.");
	return true;
}
...
bool VKRenderingBackendNS::createMultipleFramebuffers(VKRenderPassComponent* VKRPC)
{
	...
	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_DEV_SUCCESS, "VKRenderingBackend: Multiple VkFramebuffers have been created.");
	return true;
}
...
bool VKRenderingBackendNS::createDescriptorPool(VkDescriptorPoolSize* poolSize, unsigned int poolSizeCount, unsigned int maxSets, VkDescriptorPool& poolHandle)
{
	...
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to create VkDescriptorPool!");
		return false;
	}

	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_DEV_SUCCESS, "VKRenderingBackend: VkDescriptorPool has been created.");
	return true;
}
...
bool VKRenderingBackendNS::createDescriptorSets(VkDescriptorPool pool, VkDescriptorSetLayout& setLayout, VkDescriptorSet& setHandle, unsigned int count)
{
	...
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to allocate VkDescriptorSet!");
		return false;
	}

	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_DEV_SUCCESS, "VKRenderingBackend: VkDescriptorSet has been allocated.");
	return true;
}
...
bool VKRenderingBackendNS::createDescriptorSetLayout(VKRenderPassComponent* VKRPC)
{
	...
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to create VkDescriptorSetLayout!");
		return false;
	}

	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_DEV_SUCCESS, "VKRenderingBackend: VkDescriptorSetLayout has been created.");
	return true;
}
...
bool VKRenderingBackendNS::updateDescriptorSet(VKRenderPassComponent* VKRPC)
{
	...
	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_DEV_SUCCESS, "VKRenderingBackend: Write VkDescriptorSet has been updated.");
	return true;
}
...
bool VKRenderingBackendNS::createPipelineLayout(VKRenderPassComponent* VKRPC)
{
	...
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to create VkPipelineLayout!");
		return false;
	}

	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_DEV_SUCCESS, "VKRenderingBackend: VkPipelineLayout has been created.");
	return true;
}
...
bool VKRenderingBackendNS::createGraphicsPipelines(VKRenderPassComponent* VKRPC, VKShaderProgramComponent* VKSPC)
{
	...
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to to create VkPipeline!");
		return false;
	}

	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_DEV_SUCCESS, "VKRenderingBackend: VkPipeline has been created.");
	return true;
}
...
bool VKRenderingBackendNS::createCommandBuffers(VKRenderPassComponent* VKRPC)
{
	...
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to allocate VkCommandBuffer!");
		return false;
	}

	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_DEV_SUCCESS, "VKRenderingBackend: VkCommandBuffer has been created.");
	return true;
}
...
bool VKRenderingBackendNS::createSyncPrimitives(VKRenderPassComponent* VKRPC)
{
	...
	for (size_t i = 0; i < VKRPC->m_maxFramesInFlight; i++)
	{
		...
		{
			g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to create synchronization primitives!");
			return false;
		}
	}

	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_DEV_SUCCESS, "VKRenderingBackend: Synchronization primitives has been created.");
...
uint32_t VKRenderingBackendNS::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties)
{
	...
	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to find suitable memory type!!");
	return 0;
}
...
bool VKRenderingBackendNS::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory)
{
	...
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to create VkBuffer!");
		return false;
	}
	...
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to allocate VkDeviceMemory for VkBuffer!");
		return false;
	}
...
bool VKRenderingBackendNS::createVBO(const std::vector<Vertex>& vertices, VkBuffer& VBO)
{
	...
	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_DEV_VERBOSE, "VKRenderingBackend: VBO " + InnoUtility::pointerToString(VBO) + " is initialized.");
...
bool  VKRenderingBackendNS::createIBO(const std::vector<Index>& indices, VkBuffer& IBO)
{
	...
	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_DEV_VERBOSE, "VKRenderingBackend: IBO " + InnoUtility::pointerToString(IBO) + " is initialized.");
...
bool VKRenderingBackendNS::initializeVKTextureDataComponent(VKTextureDataComponent * rhs)
{
	...
	else
	{
		...
		{
			g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_WARNING, "VKRenderingBackend: try to generate VKTextureDataComponent for TextureUsageType::INVISIBLE type!");
			return false;
		}
		...
		else
		{
			...
			{
				g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_WARNING, "VKRenderingBackend: try to generate VKTextureDataComponent without raw data!");
				return false;
			}
		}
	}
...
bool VKRenderingBackendNS::submitGPUData(VKTextureDataComponent * rhs)
{
	...
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to create VkImage!");
		return false;
	}
	...
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to allocate VkDeviceMemory for VkImage!");
		return false;
	}
	...
	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_DEV_VERBOSE, "VKRenderingBackend: VkImage " + InnoUtility::pointerToString(rhs->m_image) + " is initialized.");
...
void VKRenderingBackendNS::transitionImageLayout(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, VkImageLayout oldLayout, VkImageLayout newLayout)
{
	...
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Unsupported transition!");
	}
...
bool VKRenderingBackendNS::createImageView(VKTextureDataComponent* VKTDC)
{
	...
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to create VkImageView!");
		return false;
	}

	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_DEV_VERBOSE, "VKRenderingBackend: VkImageView " + InnoUtility::pointerToString(VKTDC->m_imageView) + " is initialized.");
	return true;
}
...
bool VKRenderingBackendNS::recordCommand(VKRenderPassComponent* VKRPC, unsigned int commandBufferIndex, const std::function<void()>& commands)
{
	...
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to begin recording command buffer!");
		return false;
	}
	...
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to record command!");
		return false;
	}
...
bool VKRenderingBackendNS::submitCommand(VKRenderPassComponent* VKRPC, unsigned int commandBufferIndex)
{
	...
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to submit command buffer!");
		return false;
	}
...
bool VKRenderingBackendNS::createShaderModule(VkShaderModule& vkShaderModule, const ShaderFilePath& shaderFilePath)
{
	...
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to create VkShaderModule for: " + std::string(shaderFilePath.c_str()) + "!");
		return false;
	}

	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_DEV_SUCCESS, "VKRenderingBackend: innoShader: " + std::string(shaderFilePath.c_str()) + " has been loaded.");
	return true;
}
...
bool VKRenderingBackendNS::generateUBO(VkBuffer& UBO, VkDeviceSize UBOSize, VkDeviceMemory& UBOMemory)
{
	...
	if (!l_result)
	{
		g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_ERROR, "VKRenderingBackend: Failed to create UBO!");
		return false;
	}
	g_pCoreSystem->getLogSystem()->printLog(LogType::INNO_DEV_SUCCESS, "VKRenderingBackend: UBO has been created.");
	return true;
}
