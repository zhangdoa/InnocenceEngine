...
bool SunShadowBlurEvenPass::Setup(IServiceConfig *systemConfig)
{
	...
	m_ShaderProgramComp = l_graphicsService->AddShaderProgramComponent("SunShadowBlurEvenPass/");
	m_ShaderProgramComp->m_ShaderFilePaths.m_CSPath = "sunShadowBlurPassEven.comp/";

	m_RenderPassComp = l_graphicsService->AddRenderPassComponent("SunShadowBlurEvenPass/");
