...
bool SunShadowBlurEvenPass::PrepareCommandList(IRenderingContext* renderingContext)
{
	...
	// l_hwService->BindGPUResource(m_RenderPassComp, ShaderStage::Compute, SunShadowBlurOddPass::Get().GetResult(), 1);
	...
	// l_hwService->UnbindGPUResource(m_RenderPassComp, ShaderStage::Compute, SunShadowBlurOddPass::Get().GetResult(), 1);
