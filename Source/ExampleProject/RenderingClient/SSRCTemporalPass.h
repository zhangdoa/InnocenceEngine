...
namespace Inno
{
	class SSRCTemporalPass : public IRenderPass
	{
	public:
		INNO_CLASS_SINGLETON(SSRCTemporalPass)
		...
		// Per-pixel blur mask consumed by SSRCSpatialHorizontal/Vertical.
	...
	private:
		...
		// SSRCSpatialHorizontalPass and SSRCSpatialVerticalPass.
