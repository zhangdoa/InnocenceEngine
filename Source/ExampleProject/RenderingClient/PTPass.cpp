...
ObjectStatus PTPass::GetStatus()
{
	return m_ObjectStatus;
}

RenderPassComponent* PTPass::GetRenderPassComp()
{
	return m_RayTracingRenderPassComp;
}

GPUResourceComponent* PTPass::GetResult()
{
	return m_AccumulationBuffer;
}

void PTPass::ResetAccumulation()
{
	m_FrameCount = 1;
}

void PTPass::CreateAccumulationBuffer()
{
	...
	m_AccumulationBuffer = l_texService->Add("PTAccumBuffer");
...
void PTPass::CreatePTGBufferTextures()
{
	auto l_resolution = g_Engine->Get<RenderingConfigurationService>()->GetScreenResolution();
	auto l_texService = g_Engine->Get<TextureResourceService>();
...
void PTPass::DeletePTGBufferTextures()
{
	auto l_texService = g_Engine->Get<TextureResourceService>();
