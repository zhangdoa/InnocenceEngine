...
{
	m_projectionMatrix.initializeToPerspectiveMatrix((70.0 / 180.0) * PI, (16.0 / 9.0), 0.1, 100.0);
	//m_projectionMatrix.initializeToOrthographicMatrix(-50.0, 50.0, -100.0, 100.0, -10.0, 10.0);
