...
bool VKLightPass::initialize()
{
	...
	sunUBODescriptorBufferInfo.buffer = VKRenderingSystemComponent::get().m_sunUBO;
	...
	pointLightUBODescriptorBufferInfo.buffer = VKRenderingSystemComponent::get().m_pointLightUBO;
	pointLightUBODescriptorBufferInfo.offset = 0;
	pointLightUBODescriptorBufferInfo.range = sizeof(PointLightGPUData) * RenderingFrontendSystemComponent::get().m_maxPointLights;
	...
	sphereLightUBODescriptorBufferInfo.buffer = VKRenderingSystemComponent::get().m_sphereLightUBO;
	sphereLightUBODescriptorBufferInfo.offset = 0;
	sphereLightUBODescriptorBufferInfo.range = sizeof(SphereLightGPUData) * RenderingFrontendSystemComponent::get().m_maxSphereLights;
	...
	opaquePassRT0ImageInfo.sampler = VKRenderingSystemComponent::get().m_deferredRTSampler;
	...
	opaquePassRT1ImageInfo.sampler = VKRenderingSystemComponent::get().m_deferredRTSampler;
	...
	opaquePassRT2ImageInfo.sampler = VKRenderingSystemComponent::get().m_deferredRTSampler;
