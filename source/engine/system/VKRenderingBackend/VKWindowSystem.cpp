...
#include "../GLRenderingBackend/GLFWWrapper.h"
...
bool VKWindowSystem::setup(void* hInstance, void* hPrevInstance, char* pScmdline, int nCmdshow)
{
	return VKWindowSystemNS::setup(hInstance, hPrevInstance, pScmdline, nCmdshow);
}

bool VKWindowSystem::initialize()
{
	//initialize window
...
ObjectStatus VKWindowSystem::getStatus()
{
	return VKWindowSystemNS::m_objectStatus;
}

ButtonStatusMap VKWindowSystem::getButtonStatus()
{
