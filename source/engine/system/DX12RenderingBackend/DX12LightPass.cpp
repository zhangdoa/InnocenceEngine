...
bool DX12LightPass::update()
{
	...
	recordBindCBV(m_DXRPC, 0, 1, DX12RenderingSystemComponent::get().m_sunConstantBuffer, 0);
	recordBindCBV(m_DXRPC, 0, 2, DX12RenderingSystemComponent::get().m_pointLightConstantBuffer, 0);
	recordBindCBV(m_DXRPC, 0, 3, DX12RenderingSystemComponent::get().m_sphereLightConstantBuffer, 0);
	recordBindCBV(m_DXRPC, 0, 4, DX12RenderingSystemComponent::get().m_skyConstantBuffer, 0);
