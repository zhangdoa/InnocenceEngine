...
meshID GLRenderingSystem::addMesh()
{
	GLMesh newMesh;
...
textureID GLRenderingSystem::addTexture(textureType textureType)
{
...
BaseMesh* GLRenderingSystem::getMesh(meshID meshID)
{
	return &m_meshMap.find(meshID)->second;
}

BaseTexture * GLRenderingSystem::getTexture(textureType textureType, textureID textureID)
{
	if (textureType == textureType::CUBEMAP)
	{
...
void GLRenderingSystem::render(std::vector<CameraComponent*>& cameraComponents, std::vector<LightComponent*>& lightComponents, std::vector<VisibleComponent*>& visibleComponents)
{
...
void GLRenderingSystem::setScreenResolution(vec2 screenResolution)
{
	m_screenResolution = screenResolution;
}

void GLRenderingSystem::initializeGeometryPass()
{
	// initialize shader
...
void GLRenderingSystem::renderGeometryPass(std::vector<CameraComponent*>& cameraComponents, std::vector<LightComponent*>& lightComponents, std::vector<VisibleComponent*>& visibleComponents)
{
...
void GLRenderingSystem::initializeBackgroundPass()
{
...
void GLRenderingSystem::renderBackgroundPass(std::vector<CameraComponent*>& cameraComponents, std::vector<LightComponent*>& lightComponents, std::vector<VisibleComponent*>& visibleComponents)
{
...
void GLRenderingSystem::initializeLightPass()
{
	// initialize shader
...
void GLRenderingSystem::renderLightPass(std::vector<CameraComponent*>& cameraComponents, std::vector<LightComponent*>& lightComponents, std::vector<VisibleComponent*>& visibleComponents)
{
...
void GLRenderingSystem::initializeFinalPass()
{
...
void GLRenderingSystem::renderFinalPass(std::vector<CameraComponent*>& cameraComponents, std::vector<LightComponent*>& lightComponents, std::vector<VisibleComponent*>& visibleComponents)
{
	// draw final pass
...
void GLRenderingSystem::changeDrawPolygonMode()
{
	if (m_polygonMode == 2)
	{
		m_polygonMode = 0;
...
void GLRenderingSystem::changeDrawTextureMode()
{
	if (m_textureMode == 3)
	{
		m_textureMode = 0;
...
void GLRenderingSystem::initialize()
{
	...
	g_pLogSystem->printLog("GLRenderingSystem has been initialized.");
}
...
void GLRenderingSystem::shutdown()
{
	...
	g_pLogSystem->printLog("GLRenderingSystem has been shutdown.");
}
