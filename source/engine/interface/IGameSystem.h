...
public:
	...
	virtual void registerKeyboardInputCallback(InputComponent* inputComponent, int keyCode, std::function<void()>* function) = 0;
	virtual void registerMouseInputCallback(InputComponent* inputComponent, int mouseCode, std::function<void(double)>* function) = 0;
