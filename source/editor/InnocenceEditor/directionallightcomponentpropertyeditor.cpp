...
void DirectionalLightComponentPropertyEditor::GetLuminousFlux()
{
    if (!m_component)
        return;
...
void DirectionalLightComponentPropertyEditor::GetColor()
{
    if (!m_component)
        return;
...
void DirectionalLightComponentPropertyEditor::SetLuminousFlux()
{
    if (!m_component)
        return;
...
void DirectionalLightComponentPropertyEditor::SetColor()
{
    if (!m_component)
        return;
