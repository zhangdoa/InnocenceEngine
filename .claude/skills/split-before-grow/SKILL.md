---
name: split-before-grow
description: Use when a source file would exceed the 300-line file-size gate. Defines split shapes (multi-class vs partial-class) and naming conventions.
---

# Skill: split-before-grow
...
- `fundamentals` — *orthogonality* is the underlying principle.
