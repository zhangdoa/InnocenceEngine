...
description: Use when creating files, scratch output, or new docs. Enforces no-scratch-in-tracked-dirs, scripts location, no-subtree-README, and AI-authored *.md restrictions.
---
...
- `persistence-venue` — venue routing table.
- `backlog-workflow` — backlog is the single AI-authored project-state medium.
