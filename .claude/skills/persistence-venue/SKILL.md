...
description: Use when deciding where to record a rule, fact, snapshot, or correction. Routes content to the right venue (skill / state / task / gate / ephemeral); auto-memory venue is disabled in this project.
---

# Skill: persistence-venue
