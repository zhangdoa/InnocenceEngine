...
description: Use after every non-trivial implementation dispatch. Defines reviewer selection, brief contents, verdicts (PASS/ADVISORY/BLOCKED/UNVERIFIED), and the visual-inspection mandate for rendering CLs.
---
...
- **Backlog / docs-only** (`.backlog/`, `.md`, `.claude/`, `.alignments/`, `.gitignore`). Closing a task → review still required.
