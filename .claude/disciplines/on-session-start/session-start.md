...
- `always/backlog-workflow.md` — Implementation Notes are the cross-session medium this discipline reads.
- `on-dispatch/agent-dispatch.md` — main-session dispatches the producer in foreground at session start (legitimate two-condition match).
