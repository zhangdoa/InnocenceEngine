...
- `on-commit/peer-review-required.md` — UNVERIFIED tier, reviewer-visual-inspection mandate, `Reviewed-Visually:` footer, `visual-review` gate.
- `on-bug/perf-measurement-frame-budget.md` — visual verification out of scope for N-picking.
- `on-bug/regression-fix-flow.md`, `dispatcher/dispatch-briefs.md` — stop-the-line on accumulating carry-forwards.
